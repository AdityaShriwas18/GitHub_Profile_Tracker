  ...
  return (
    ...
    <ul>
      ...
      <li className='mt-[2vh]' ><span className='font-bold text-xl mx-1'>Account Type: </span><span>Is it a Personal accounts, Organization accounts or Enterprise accounts. </span></li>
        ...
        <li className='mt-[2vh]' ><span className='font-bold text-xl mx-1'>Blog: </span><span>Any blog or website by the user.</span></li>
    ...
    <p>At GitHub Profile Tracker, we are committed to providing a seamless and efficient experience. Our service is not just about finding profiles; it's about connecting people, enhancing collaboration, and building a community of developers who can easily find each other and share their work.</p>
